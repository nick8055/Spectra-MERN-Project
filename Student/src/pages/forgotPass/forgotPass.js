...
const ForgotPassword = () => {
  ...
  const handleRequestOTP = async () => {
    setIsLoading(true);
    try {
      await axios.post(process.env.REACT_APP_SERVER_URL + '/api/students/forgot-password', { email });
      setError('');
  ...
  const handleResetPassword = async () => {
    setIsLoading(true);
    try {
      await axios.post(process.env.REACT_APP_SERVER_URL + '/api/students/reset-password', { email, otp, newPassword });
      setError('');
